...
constexpr double radius_eps = 1e-10;
constexpr double pi = 3.141592653589793;
constexpr double invs_pi = sqrt(1./pi);
constexpr double invs_2 = sqrt(0.5);
constexpr double s_2 = sqrt(2.);
constexpr double s_3 = sqrt(3.);
constexpr double s_5 = sqrt(5.);
constexpr double s_7 = sqrt(7.);
constexpr double s_11 = sqrt(11.);
constexpr double s_13 = sqrt(13.);
constexpr double pre1 = invs_2*0.5*s_3*invs_pi;
constexpr double pre1_a = invs_2*pre1;
constexpr double pre2 = invs_2* 0.25*s_5*invs_pi;
constexpr double pre2_a = 2*pre2*s_3*invs_2;
constexpr double pre2_b = pre2*s_3*invs_2;
constexpr double pre3 = invs_2* 0.25*invs_pi*s_7;
constexpr double pre3_a = 0.5*pre3*s_3;
constexpr double pre3_b = pre3*s_3*s_5*invs_2;
constexpr double pre3_c = 0.5*pre3*s_5;
constexpr double pre4 = invs_2* 0.1875*invs_pi;
constexpr double pre4_a = 2*pre4*s_5;
constexpr double pre4_b = pre4_a*invs_2;
constexpr double pre4_c = pre4_a*s_7;
constexpr double pre4_d = pre4_b*0.5*s_7;
constexpr double pre5 = invs_2* 0.0625*invs_pi*s_11;
constexpr double pre5_a = pre5*s_3*s_5*invs_2;
constexpr double pre5_b = pre5_a*s_7*2;
constexpr double pre5_c = pre5*0.5*s_7*s_5;
constexpr double pre5_d = pre5_c*6*invs_2;
constexpr double pre5_e = pre5*1.5*s_7;
constexpr double pre6 = invs_2* 0.03125*invs_pi*s_13;
constexpr double pre6_a = pre6*s_7*s_3*invs_2*2;
constexpr double pre6_b = pre6_a*s_5*0.25*s_2;
constexpr double pre6_c = pre6_b*2;
constexpr double pre6_d = pre6*s_7*invs_2*3;
constexpr double pre6_e = pre6_d*s_11*s_2;
constexpr double pre6_f = pre6_e*s_3/6.;
